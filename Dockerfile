...
RUN ./squashfs-root/usr/bin/nvim -u .vimrc -c 'CocInstall -sync coc-pairs coc-marketplace coc-github coc-clock coc-yaml coc-wxml coc-vimlsp coc-tsserver coc-sh coc-python coc-phpls coc-html coc-docker coc-css coc-python | qall'
