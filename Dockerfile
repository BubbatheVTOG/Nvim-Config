...
RUN ./squashfs-root/usr/bin/nvim -u .vimrc -c 'CocInstall -sync coc-clock coc-css coc-docker coc-eslint coc-github coc-html coc-import-cost coc-json coc-markdownlint coc-marketplace coc-phpls coc-prettier coc-python coc-sh coc-tag coc-tsserver coc-vimlsp coc-yaml | qall'
